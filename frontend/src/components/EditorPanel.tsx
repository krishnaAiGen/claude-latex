...
export default function EditorPanel() {
  const { latexContent, editorReadOnly, isAgentProcessing, theme, activeFilePath, currentProjectId } = useEditorStore();
      ...
      editor.addAction({
        ...
        run: () => {
          ...
          if (text) {
            ...
            // Focus chat input (dispatch custom event)
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      >
        ...
        {isAgentProcessing && (
          <span className="animate-pulse-subtle" style={{ color: "var(--warning)" }}>AI editing...</span>
        )}
      </div>
